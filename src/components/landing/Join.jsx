...
function Join({header}) {
    return(
        ...
        <div className="max-w-[840px] lg:max-w-[1080px] w-full mx-auto bg-gradient-to-b from-orange-400 to-transparent">
            <div className="mt-8">
                <div className="flex flex-col text-white font-primary">
                    <div className="my-3 md:my-6 text-xl text-center">
                        {header}
                    </div>
                    <div className="mt-4 mb-8 mx-8 sm:mx-14 md:mx-20 lg:mx-28 text-4xl sm:text-6xl md:text-7xl lg:text-8xl text-center">
                    ...
                    <div className="mx-6 md:mx-28 mb-8 flex gap-2 justify-around">
                        ...
                        <a href="https://t.me/martianbitcoin">
                            <div className="bg-black p-1 md:p-4 text-lg md:text-2xl lg:text-3xl font-primary">Join Telegram</div>
                        </a>
                        <a href="https://discord.gg/yNKHrqnTFF">
                            <div className="bg-black p-1 md:p-4 text-lg md:text-2xl lg:text-3xl font-primary">Join Discord</div>
                        </a>
