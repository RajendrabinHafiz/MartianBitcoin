            ...
            <div class="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-3 gap-8 text-white font-primary">
                    <div className="flex flex-col gap-4">
                        <div>Martian</div>
                        <a href="#" className="transition hover:opacity-75 hover:text-blue-600">Home</a>
                        <a href="#" className="transition hover:opacity-75 hover:text-blue-600">About</a>
                        <a href="#" className="transition hover:opacity-75 hover:text-blue-600">Presale</a>
                    </div>
                    <div className="flex flex-col gap-4">
                        <div>Market</div>
                        <a href="#" className="transition hover:opacity-75 hover:text-blue-600">Buy MARS</a>
                        <a href="#" className="transition hover:opacity-75 hover:text-blue-600">Whitepaper</a>
                    </div>
                    <div className="flex flex-col gap-4">
                        <div>Contact</div>
                        <a href="#" className="transition hover:opacity-75 hover:text-blue-600">Email</a>
                        <a href="#" className="transition hover:opacity-75 hover:text-blue-600">Twitter</a>
                    </div>
                </div>
            </div>
